...
const SparkleNavbar = ({ items, color = "#00fffc", onNavigate, initialIndex = 0 }) => {
      ...
      keyframes: [
        {
          ...
          onStart: () => {
            ...
            gsap.to(activeElement, { "--active-element-opacity": 1, duration: 0.2 });
          },
        },
        {
          ...
          ease: "expo.in",
          onStart: () => {
            gsap.to(activeElement, { "--active-element-mask-position": "40%", duration: 0.7 });
            gsap.to(activeElement, { "--active-element-opacity": 0, delay: 0.55, duration: 0.2 });
          },
          onComplete: () => {
  ...
  return (
    <>
      <style>{`
        .navigation-menu { margin: 0; position: relative; z-index: 1; }
        ...
        .navigation-menu ul li.active button { color: white; }
